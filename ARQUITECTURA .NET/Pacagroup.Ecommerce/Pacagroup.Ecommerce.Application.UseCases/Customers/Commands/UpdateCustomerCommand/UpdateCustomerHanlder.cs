...
{
    public class UpdateCustomerHanlder : IRequestHandler<UpdateCustomerCommand, Response<bool>>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;

        public UpdateCustomerHanlder(IUnitOfWork unitOfWork, IMapper mapper)
        {
