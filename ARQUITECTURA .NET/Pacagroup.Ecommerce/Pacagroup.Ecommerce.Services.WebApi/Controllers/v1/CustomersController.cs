...
namespace Pacagroup.Ecommerce.Services.WebApi.Controllers.v1
{
    ...
    public class CustomersController : Controller
    {
        ...
        [HttpPut("Update")]
        public IActionResult Update([FromBody] CustomerDTO cusotmerDto)
        {
            if (cusotmerDto == null)
            {
                return BadRequest();
            ...
            var response = _customerApplication.Update(cusotmerDto);
        ...
        [HttpPut("UpdateAsync")]
        public async Task<IActionResult> UpdateAsync([FromBody] CustomerDTO cusotmerDto)
        {
            if (cusotmerDto == null)
            {
                return BadRequest();
