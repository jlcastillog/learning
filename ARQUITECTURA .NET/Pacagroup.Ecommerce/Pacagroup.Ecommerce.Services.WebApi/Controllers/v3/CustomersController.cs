...
namespace Pacagroup.Ecommerce.Services.WebApi.Controllers.v3
{
    ...
    public class CustomersController : Controller
    {
        ...
        {
            var customerDto = await _mediator.Send(new GetCusomerQuery() { CustomerId = customerId});
        ...
        public async Task<IActionResult> Delete([FromRoute] string custormerId)
        {
            ...
            var response = await _mediator.Send(new DeleteCustomerCommand() { CustomerId = custormerId});
        ...
        public async Task<IActionResult> Get([FromRoute] string customerId)
        {
            ...
            var response = await _mediator.Send(new GetCusomerQuery() { CustomerId = customerId});
